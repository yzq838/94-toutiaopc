<template>
  <div class="login">
      ...
      <el-card class="login-card">
        ...
        <!-- 表单 绑定model属性 绑定rules属性  ref手动校验方法-->
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" style="margin-top:20px">
          ...
          <el-form-item  prop="checked"  >
            <!-- 表单域 勾选 是否同意-->
            <el-checkbox v-model="loginForm.checked">我已阅读用户协议和隐私条款</el-checkbox>
         </el-form-item>
         <el-form-item>
            <!-- 表单域 -->
      ...
      loginRules: {
        ...
        checked: [{
          validator: function (rule, value, callback) {
            ...
            value ? callback() : callback(new Error('您必须同意服务条款和隐私协议'))
          }
        }]
      }
    }
